...
# === Memory & State ===
user_memory = {"name": "yourname", "last_schedule": None}
...
def generate_prompt(user_input, intent, user_memory, conversation_history):
    ...
    if intent == "schedule":
        prompt_parts.extend([
            ...
            "6. If it involves studying or learning, make sure to allocate more time for it and include breaks",
...
class ArtMindApp:
    def __init__(self, root):
        ...
        self.text_widget.insert(tk.END, "👩‍🎨 Aurora: Hello <username>! How can I assist you today?\n\n") #update the usernmame
    ...
    def clear_context(self):
        ...
        self.text_widget.insert(tk.END, "👩‍🎨 Aurora: Conversation history cleared. Hello again <username>!\n\n") #update username
        self.text_widget.configure(state='disabled')
